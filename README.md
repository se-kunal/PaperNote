...
[![Downloads](https://img.shields.io/github/downloads/se-kunal/PaperNote/total?label=downloads&color=B0722C)](https://github.com/se-kunal/PaperNote/releases)
[![Latest release](https://img.shields.io/github/v/release/se-kunal/PaperNote?label=latest&color=1C1B18)](https://github.com/se-kunal/PaperNote/releases/latest)
[![Stars](https://img.shields.io/github/stars/se-kunal/PaperNote?label=stars&color=D98E48)](https://github.com/se-kunal/PaperNote/stargazers)

[**Download the latest release**](https://github.com/se-kunal/PaperNote/releases/latest) · [**Website**](https://se-kunal.github.io/PaperNote/)
...
**Is the source code available?** Not yet. The source is closed while the product finds
its feet; this repo is the home for releases, the website, and issues. That may change.
